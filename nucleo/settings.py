...
SECRET_KEY = 'django-insecure-bjbopu-=zt&r!dwdgu2eweuy1t%+5r9w8(@2fzfi5^j7r5igzr'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Asegúrate de que esta ruta esté configurada correctamente
]
...
AUTH_USER_MODEL = 'apiverriss.Usuario'
...
AUTHENTICATION_BACKENDS = [
    ...
    'apiverriss.authentication.EmailOrUsernameBackend',  # Agregar el nuevo backend
]
